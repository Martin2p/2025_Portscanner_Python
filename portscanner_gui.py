...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.localHostsText.setGeometry(QRect(280, 140, 281, 141))
        self.openPortsText = QTextEdit(self.centralwidget)
        self.openPortsText.setObjectName(u"openPortsText")
        self.openPortsText.setGeometry(QRect(10, 290, 191, 101))
        ...
        self.freePortsText.setGeometry(QRect(10, 140, 191, 101))
        ...
        self.openPortsBtn.setGeometry(QRect(10, 400, 131, 26))
